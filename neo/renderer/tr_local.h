...
extern idCVar r_framebufferWidth;       // When not zero, render to a framebuffer of this size
extern idCVar r_framebufferHeight;      // When not zero, render to a framebuffer of this size
